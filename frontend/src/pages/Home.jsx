...
import ShiningDotsAnimation from '../components/ui/ShiningDotsAnimation'
  ...
  useEffect(() => {
    const fetchTestimonials = async () => {
      try {
        ...
        const response = await testimonialService.getFeaturedTestimonials(5)
        setTestimonials(response.testimonials || [])
      } catch (error) {
        console.error('Error fetching testimonials:', error)
        // Keep testimonials as empty array for graceful fallback
        setTestimonials([])
      } finally {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
          <div className="text-center">
            ...
            <div className="relative">
              ...
              {/* Shining Dots Animation */}
              <ShiningDotsAnimation />
            </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            {testimonialsLoading ? (
              <div className="md:col-span-12 flex items-center justify-center py-16">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-slate-900"></div>
              </div>
              ...
              <div className="md:col-span-12 text-center py-16">
                ...
                <p className="text-slate-600 mb-6">Be the first to share your experience with our platform!</p>
                <button
                  ...
                  <div className="p-8 h-full flex flex-col">
                    ...
                    <div className="flex items-center mb-6">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-slate-500">
                          {testimonial.role || 'Content Creator'}
                    ...
                    <div className="flex-1 mb-6">
                      <p className="text-slate-600 italic relative">
                        ...
                        {testimonial.message.substring(0, index === 0 ? 300 : index === 1 ? 200 : 150)}
                        {testimonial.message.length > (index === 0 ? 300 : index === 1 ? 200 : 150) && '...'}
                      ...
                      <div className="flex items-center">
                        {[...Array(5)].map((_, i) => (
                          <svg
                            ...
                            stroke="currentColor"
                            className={`${i < testimonial.rating ? 'text-yellow-400' : 'text-slate-200'} w-4 h-4`}
                          >
